...
p1 = ggplot(lb20_filter, aes(x=Age, fill=sexFact)) + 
  geom_bar(data=subset(lb20_filter, sexFact=="Female"), aes(y=-..count..)) +
  geom_bar(data=subset(lb20_filter, sexFact=="Male"), aes(y=..count..)) +
  ...
  coord_flip() +
  theme_minimal() +
  theme(plot.title = element_text(hjust = 0.5)) #tidy
...
### "Population Pyramid for 2020 Latinobarómetro Dataset"
